# Image Classification using Tensorflow without Keras
...
def dense(inputs, weights):
    x = tf.nn.leaky_relu(tf.matmul(inputs, weights), alpha=leaky_ReLu_a)
